...
setup(
    ...
    extras_require={
        ...
        # extra quantization plugin (RhizoNymph fork — adds gemma4 GGUF support)
        "extra-quant": [
            "vllm-gguf-plugin @ git+https://github.com/RhizoNymph/vllm-gguf-plugin@feat/gemma4-support",
        ],
    },
    cmdclass=cmdclass,
