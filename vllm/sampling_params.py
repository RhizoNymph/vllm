...
class SamplingParams(
    ...
    @cached_property
    def effective_prefill_steering(self) -> ResolvedSteeringVectors | None:
    ...
    @cached_property
    def effective_decode_steering(self) -> ResolvedSteeringVectors | None:
