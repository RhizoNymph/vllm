...
class EngineCore:
    ...
    def __init__(
        ...
        # Capture consumers (spec invariant 9): reject TP/PP > 1 loudly
        # at engine init rather than leaving a half-working capture
        # path behind.  Multi-rank residual collection is explicitly
        # out of scope for v1.  The error names the configured
        # consumers so operators can correlate with their config.
