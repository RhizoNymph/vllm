...
use crate::protocol::sae::{SaeClampSpec, SaeFullReconstructionSpec};
...
pub struct EngineCoreSamplingParams {
    ...
    /// layer map needs msgpack integer keys — see [`crate::protocol::sae::SaeClampHookMap`].
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
mod tests {
    ...
    use crate::protocol::{
        ClampHookTable, SaeClampEntry, SaeClampKind, SaeClampSpec, SaeFullReconstructionSpec,
        SaePhase, SteeringClamps, SteeringLayerEntry, decode_msgpack, decode_value, encode_msgpack,
    };
    ...
    fn sae_clamp_wire_hex_fixture_for_python_cross_compat() {
        ...
        expect_test::expect![""].assert_eq(&hex);
    }
